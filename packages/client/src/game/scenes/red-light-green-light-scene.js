...
exports.loadRedLightGreenLightScene = loadRedLightGreenLightScene;
const core_1 = require("@babylonjs/core");
function loadRedLightGreenLightScene(engine, physics) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        core_1.MeshBuilder.CreateBox("box", {
            height: 1,
            width: 100,
            depth: 100,
        }, scene);
        scene.enablePhysics(new core_1.Vector3(0, -9.8, 0), physics);
